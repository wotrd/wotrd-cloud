 ...
 */
@Slf4j
@Extension(bizId = BizConstant.BIZ_TWO, useCase = BizConstant.USER_CASE_TWO)
public class BizTwoConstructOrderProcessorExtPt implements ProcessorExtPt<CreateOrderRequest, CreateOrderResult, CreateOrderContext> {

    @Override
    public void process(FlowContext flowContext) {
        log.info("bizTwo process");
    }
}
